...
/**
 * Created by Christophe on 04/11/2021.
 * Add two meeting and filter by date , and reset
 */

@LargeTest
@RunWith(AndroidJUnit4.class)
public class MeetingListActivityTestFilterByDate {
    ...
    @Test
    public void meetingListActivityTestFilterByDate() {
        ...
        // app : Option menu : FILTER BY DATE >>>> Current date is choise to filter
        //
        //open menu selection
        ...
        //select filter by date of meeting in dialog
        ViewInteraction materialTextView3 = onView(
                allOf(withId(R.id.title), withText("Filtrer par date"),
                        isDisplayed()));
        materialTextView3.perform(click()); // here , current date in DatePicker
        // possible to set date 2021-11-30 in DatePicker
        //  onView(withClassName(Matchers.equalTo(DatePicker.class.getName()))).perform(PickerActions.setDate(2021, 11, 30));
        //validate the date selected
        ...
        // app : Option menu : RESET (after filter date)
